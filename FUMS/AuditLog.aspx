<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AuditLog.aspx.cs" Inherits="FloraSoft.Cps.UserMgr.AuditLog" %>
...
<div class="row">   
    <div class="col-md-2">
        <asp:DropDownList CssClass="form-control" ID="BranchList" runat="server" Width="150px" DataTextField="BranchName" DataValueField="RoutingNo"></asp:DropDownList>
    </div>
    <div class="col-md-3">
        <table border="0">
            <tr>
